...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_cfg_entry_point": "isaaclab_rl.isaaclab_rl.rsl_rl.runners.on_policy_runner_cfg:RslRlOnPolicyRunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_ppo_cfg.yaml",
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_ppo_cfg.yaml",
        "sb3_cfg_entry_point": f"{agents.__name__}:sb3_ppo_cfg.yaml",
        "distill_cfg_entry_point": "isaaclab_rl.isaaclab_rl.isaaclab_rl.rsl_rl.distillation_cfg:RsLRLDistillationAlgorithmCfg",
    },
    disable_env_checker=True,
)
